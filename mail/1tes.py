...
def lancer_script():
    ...
    print("Ouverture des envoie...")  # Impression de débogage
    envoie_path = os.path.join(os.path.dirname(__file__), "envoie.py")
    print(f"Chemin du script paramètre : {envoie_path}")  # Impression de débogage
    charger_et_executer_script(envoie_path)
